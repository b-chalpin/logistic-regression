    ...
    for lam in [0,10]:
        for z_r in [1,2]:
            for eta in [0.01,0.001]:
                ...
                print(f"Passed GD run with hyperparams: lam: {lam}, r: {z_r}, eta: {eta}")
    if not passed:
        ...
        for z_r in [1,2]:
            for eta in [0.01,0.001]:
                for mbs in [1,20,n]:
                    ...
                    print(f"Passed SGD run with hyperparams: lam: {lam}, r: {z_r}, eta: {eta}, mbs: {mbs}")
    if not passed:
